...
public class Pj3dLauncher extends Applet
{
	public void init()
	{
		...
		*/
		...
		plane.transform.setPosition(0, -30, -100);
		//plane.shader.setTexture("luzi_in_snow2.jpg");
		
		// create a sphere
		Pj3dSphere sphere = new Pj3dSphere(p, 20);
		sphere.transform.setPosition(0, 0, -130);
		//sphere.shader.setTexture("rainbow.jpg");
		//sphere.shader.setTexture("orange.jpg");
		//sphere.transform.setScale(10);
		
		//Pj3dCone cone = new Pj3dCone(p, 30, 80);
		
		Pj3dCylinder cyl = new Pj3dCylinder(p, 30, 80, 5, 5);
