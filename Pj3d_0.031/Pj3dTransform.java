...
public class Pj3dTransform {
	...
	public void translate(int x, int y, int z)
   	{	
		transformVector.x += x; //ptools.Int2Float(x);
		transformVector.y += y; //ptools.Int2Float(y);
		transformVector.z += z; //ptools.Int2Float(z);
	...
	{
		transform3D.setScale((double)s); //ptools.Int2Double(s));
		transformgroup.setTransform(transform3D);
	}
