...
public class Pj3dPickable extends Pj3dToolbox
{
	...
	/// constructor
	///
	public Pj3dPickable(Pj3d parent, BranchGroup pickedBranch, Shape3D pickedShape)
	{
		this.parent = parent;
	...
	{	
		...
		//Shape3D prim = (Shape3D)transform.transformgroup.getChild(0);
		shader.appearance = pickedShape.getAppearance();
	}
}
